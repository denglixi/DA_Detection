...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16_multiscale':
        fasterRCNN = vgg16_multiscale(imdb.classes, pretrained=True,
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            rois, cls_prob, bbox_pred, \
                ...
                rois_label, out_d_pixel, out_d_pixel_2, out_d_pixel_3, out_d_pixel_4, out_d = fasterRCNN(
            ...
            if args.train_domain_loss:
                ...
                out_d_pixel, out_d_pixel_2, out_d_pixel_3, out_d_pixel_4, out_d = fasterRCNN(

...
if __name__ == '__main__':
    ...
    from model.faster_rcnn.vgg16_imglevel import vgg16
    from model.faster_rcnn.resnet_imglevel import resnet

    if args.net == 'vgg16':
        fasterRCNN = vgg16(imdb.classes, pretrained=True,
                           class_agnostic=args.class_agnostic, context=args.context)
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        save_name = os.path.join(output_dir,
                                 'so_{}_target_{}_context_{}_gamma_{}_{}_{}_{}.pth'.format(args.ef, args.dataset_t,
                                                                                           args.context, args.gamma,
                                                                                           args.session, epoch,
                                                                                           step))
        save_checkpoint({
